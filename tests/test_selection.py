...
def test_s5_drops_role_inadmissible_for_its_slots():
...
def test_hook_preempts_develop_when_no_other_admissible_candidate():
    ...
    slots_json = _slots(1)
    selection = {"selected": [
        {"candidate_id": "c04", "role": "develop", "rank": 1, "exercise": "x", "reason": "x"},
        {"candidate_id": "c06", "role": "develop", "rank": 2, "exercise": "x", "reason": "x"},
        {"candidate_id": "close0", "role": "close", "rank": 1, "exercise": "x", "reason": "x"},
    ]}
    selected, warnings, fallback_roles = build_selected(candidates_json, slots_json, selection)
...
def test_close_preempts_develop_when_no_other_admissible_candidate():
    candidates_json = {"candidates": [
        _cand("hook0", "a.mov", "peak"),
    ...
    slots_json = _slots(1)
    selection = {"selected": [
        {"candidate_id": "hook0", "role": "hook", "rank": 1, "exercise": "x", "reason": "x"},
        {"candidate_id": "c05", "role": "develop", "rank": 1, "exercise": "x", "reason": "x"},
    ]}
    selected, warnings, fallback_roles = build_selected(candidates_json, slots_json, selection)
...
def test_develop_absorbs_preemption_without_backfill_when_pool_empty():
...
def test_no_preemption_when_hook_has_own_admissible_candidate():
    candidates_json = {"candidates": [
        _cand("hook0", "a.mov", "peak", kp_speed=0.9, sharpness=0.9),
        _cand("dev0", "b.mov", "peak"),
