    ...
    "clips": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "effect_params": { "type": "object", "description": "Con clave `text` (+ font, font_size, text_y, text_frames, fade_frames) el render sobreimprime el hook_line del selector (§6.6). Para `end_card`: bg, fg, font, handle, line, logo_w, logo_h, text_size (§6.8)" },
          "color_fix": {
            "type": "object",
